...
#################Тест-Сьют 1: Проверка формы "Sign In"#################
...
#################Тест-Сьют 2: Проверка формы "Sign Up"#################
...
class Registration(unittest.TestCase):
  ...
  def _fill_reg_form_fields(self, email, password):
    self.email_field.clear()
    self.email_field.send_keys(email)
    self.pass_field.send_keys(password)
    self.pass_repeat.send_keys(password)
  ...
  def test_succesfull_registration(self):
    print("test_succesfull_registration")
    self._fill_reg_form_fields(rand.generate_random_email(5), "180175Ilya")
    self.submit_btn.click()
    sleep(1.5)
  ...
  def test_bad_registration_wrong_email_format(self):
    print("test_bad_registration_wrong_email_format")
    self._fill_reg_form_fields(rand.generate_random_wrong_email(7),'180175Ilya')
    self.submit_btn.click()
    sleep(1.5)
    usrErr = self.driver.find_element(By.CLASS_NAME,"error")
    self.assertEqual(usrErr.text,"Invalid email address")
  ...
  def test_bad_registration_wrong_pass_space(self):
    print("test_bad_registration_wrong_pass_space")
    self._fill_reg_form_fields(rand.generate_random_email(10),' 180175Ilya')
    self.submit_btn.click()
    sleep(1.5)
    usrErr = self.driver.find_element(By.CLASS_NAME,"error")
  ...
  # def test_bad_registration_wrong_pass_space(self):
  #   print("test_bad_registration_wrong_pass_space")
  #   self._fill_reg_form_fields(rand.generate_random_email(7),'180175Ilya')
  #   self.submit_btn.click()
  #   sleep(1.5)
  #   usrErr = self.driver.find_element(By.CLASS_NAME,"error")
